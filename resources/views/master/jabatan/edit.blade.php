...
@section('content')
    ...
    <div class="sdv-header" style="align-items:center;">
        <a href="{{ route('master.jabatan.index') }}" class="sdv-back" title="Back">
            <i class="bi bi-arrow-left"></i>
        </a>
        <h1 class="sdv-header-title" style="margin:0;">Edit Position</h1>
    </div>
        ...
        <form action="{{ route('master.jabatan.update', $jabatan) }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode" value="{{ old('kode', $jabatan->kode) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="singkatan" value="{{ old('singkatan', $jabatan->singkatan) }}"
                ...
                <div class="form-group form-span-2">
                    <label class="form-label">Position Name <span class="req">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                        ...
                        <option value="0" {{ old('status', $jabatan->status) == '0' ? 'selected' : '' }}>Non-aktif</option>
                    </select>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('master.jabatan.index') }}" class="btn-cancel">Cancel</a>
            </div>
        </form>
    </div>
</div>
