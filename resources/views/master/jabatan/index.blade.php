...
@section('page-title', 'Position Master')

@section('content')

<div class="page-header">
    <h1 class="page-title">Positions</h1>
    <p class="page-subtitle">Manage position data registered in the system.</p>
</div>

<div class="dt-card">
    <div class="dt-card-header">
        <span class="dt-card-title">Position List</span>
        ...
        <table id="tblJabatan" class="tbl" style="width:100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Position Name">{{ $item->nama }}</td>
...
<div class="modal-backdrop-custom" id="modalHapus">
    <div class="modal-box">
        ...
        <div class="modal-title">Delete Position?</div>
...
$(function () {
    $('#tblJabatan').DataTable({
        ...
        language: {
            ...
            zeroRecords: 'No matching records found', emptyTable: 'No position data available',
            paginate: {
...
function confirmDelete(id, nama) {
    document.getElementById('modalDesc').textContent = `Position "${nama}" will be permanently deleted and cannot be recovered.`;
