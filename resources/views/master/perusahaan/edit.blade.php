...
@section('content')
    ...
    <div class="sdv-header" style="align-items:center;">
        ...
        <h1 class="sdv-header-title" style="margin:0;">Edit Company</h1>
    </div>
    ...
    <div>
        <div class="card card-body">
            ...
            <form action="{{ route('master.perusahaan.update', $perusahaan) }}" method="POST"
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group form-span-2">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $perusahaan->nama) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="singkatan" value="{{ old('singkatan', $perusahaan->singkatan) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control @error('status') is-invalid @enderror">
                            ...
                            <option value="1" {{ old('status', $perusahaan->status) == '1' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="0" {{ old('status', $perusahaan->status) == '0' ? 'selected' : '' }}>
                                Non-aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-msg">{{ $message }}</div>
                    ...
                    <div class="form-group form-span-2">
                        ...
                        @if ($perusahaan->logo)
                            <div style="margin-bottom:.75rem;display:flex;align-items:center;gap:1rem;">
                                ...
                                <label
                                    style="display:flex;align-items:center;gap:.4rem;font-size:.85rem;cursor:pointer;color:#dc2626;">
