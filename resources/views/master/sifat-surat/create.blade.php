...
@section('title', 'Add Letter Classification')
@section('page-title', 'Add Letter Classification')
...
@section('content')
    ...
    <div class="sdv-header" style="align-items:center;">
        ...
        <h1 class="sdv-header-title" style="margin:0;">Add Letter Classification</h1>
    </div>
