...
@section('page-title', 'Edit Departement')
...
@section('content')
    ...
    <div class="sdv-header" style="align-items:center;">
        ...
        <h1 class="sdv-header-title" style="margin:0;">Edit Department</h1>
    </div>
    ...
    <div>
        <div class="card card-body">
            ...
            <form action="{{ route('master.departemen.update', $departemen) }}" method="POST">
                @csrf @method('PUT')
                <div class="form-grid">

                    <div class="form-group">
                        <label class="form-label">Code <span class="req">*</span></label>
                        <input type="text" name="kode" value="{{ old('kode', $departemen->kode) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="singkatan" value="{{ old('singkatan', $departemen->singkatan) }}"
                    ...
                    <div class="form-group form-span-2">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $departemen->nama) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control @error('status') is-invalid @enderror">
                            ...
                            <option value="1" {{ old('status', $departemen->status) == '1' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="0" {{ old('status', $departemen->status) == '0' ? 'selected' : '' }}>
                                Non-aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-msg">{{ $message }}</div>
