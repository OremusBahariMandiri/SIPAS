...
<div class="page-header">
    <div class="page-header-row">
        ...
        <div class="page-header-text">
            ...
            <p class="page-subtitle">Perbarui data <strong>{{ $departemen->nama }}</strong>.</p>
        </div>
    </div>
</div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                        ...
                        <option value="1" {{ old('status', $departemen->status) == '1' ? 'selected' : '' }}>Aktif</option>
                        <option value="0" {{ old('status', $departemen->status) == '0' ? 'selected' : '' }}>Non-aktif</option>
                    </select>
