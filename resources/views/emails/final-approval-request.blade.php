...
<title>Final Approval Request</title>
<style>
  ...
  .badge { display:inline-block; background:#16a34a; color:#fff; font-size:11px; font-weight:700; padding:3px 10px; border-radius:20px; margin-bottom:6px; letter-spacing:.4px; text-transform:uppercase; }
  ...
  .final-note { background:#f0fdf4; border:1px solid #bbf7d0; border-radius:8px; padding:12px 16px; font-size:13px; color:#14532d; margin-bottom:22px; line-height:1.5; }
  .cta-wrap { text-align:center; margin-bottom:24px; }
  .cta-btn { display:inline-block; background:#16a34a; color:#fff !important; text-decoration:none; padding:12px 32px; border-radius:8px; font-size:14px; font-weight:700; letter-spacing:.3px; }
...
<div class="wrapper">
  ...
  <div class="header">
    <div class="badge">Final Approval</div>
    <h1 class="header-title">Document Ready for Final Approval</h1>
  ...
  <div class="body">
    ...
    <p class="intro">
      A document has completed all forwarding stages and is now awaiting your
      <strong>final approval</strong>. Please review and approve or reject it at your earliest convenience.
    </p>

    @if($submission->terusans->isNotEmpty())
    <div class="final-note">
      ✓ All {{ $submission->terusans->count() }} forwarding stage(s) have been approved.
      This document is now ready for your final decision.
    </div>
    @endif
