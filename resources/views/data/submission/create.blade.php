    ...
    <div class="sdv-card">
        <div class="sdv-card-head">
            <h2 class="sdv-card-title">
                <i class="bi bi-file-earmark-plus"></i> Document Details
            </h2>
        </div>
                        ...
                        <div class="scf-tte-count-wrap">
                            ...
                            <div class="scf-tte-count-input">
                                ...
                                <input type="number" name="require_tte_kepada" id="require_tte_kepada"
                                    value="{{ old('require_tte_kepada', 1) }}" min="0" max="10"
                                    class="scf-tte-count-field">
                                <button type="button" class="scf-tte-count-btn"
                                    onclick="adjustTteCount('require_tte_kepada',1,0)">+</button>
                            </div>
                            <small
                    ...
                    <div class="form-group">
                        ...
                        <select id="id_sifat_surat" name="id_sifat_surat"
                            ...
                            @foreach ($sifatSurats as $s)
                                <option value="{{ $s->id }}"
                                    {{ old('id_sifat_surat') == $s->id ? 'selected' : '' }}>
                                    {{ $s->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="scf-section-head">
                        <label class="scf-toggle-wrap" for="chkTerusan">
                            <span class="toggle-switch">
                                <input type="checkbox" id="chkTerusan" {{ old('terusan') ? 'checked' : '' }}>
                ...
                <div class="scf-actions">
                    <div class="scf-action-group">
                        <div class="scf-btns">
                            ...
                            <a href="{{ route('data.submission.index') }}" class="sdv-btn sdv-btn-ghost">Cancel</a>
                        </div>
        ...
        <div
            ...
            <div
                ...
                <button type="button" id="submitModalYes" class="sdv-btn sdv-btn-primary" style="min-width:130px;">
                    <i class="bi bi-send"></i> Yes, submit
                </button>
            </div>
        </div>
    </div>
